...
<%
	...
	try{
		...
		//입력객체 (서버)
		BufferedInputStream bis= new BufferedInputStream(new FileInputStream(f));//보조스트림으로 읽으면 더 빠르기때문에 사용
		//출력객체(브라우저)
		BufferedOutputStream bos= new BufferedOutputStream(response.getOutputStream()); //받는입장이라 response
